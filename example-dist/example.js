...
/***/ "../node_modules/css-loader/index.js??ref--5-1!../node_modules/postcss-loader/lib/index.js??ref--5-2!../node_modules/sass-loader/lib/loader.js??ref--5-3!./scripts/index.scss":
/*!******************************************************************************************************************************************************************!*\
  !*** ../node_modules/css-loader??ref--5-1!../node_modules/postcss-loader/lib??ref--5-2!../node_modules/sass-loader/lib/loader.js??ref--5-3!./scripts/index.scss ***!
  \******************************************************************************************************************************************************************/
...
function createOptions(_a) {
    var selector = _a.selector, _b = _a.resolution, resolution = _b === void 0 ? 1 : _b, _c = _a.count, count = _c === void 0 ? 240 : _c, main = _a.main, _d = _a.mainRatio, mainRatio = _d === void 0 ? 0.65 : _d, _e = _a.auxiliaries, auxiliaries = _e === void 0 ? [] : _e;
...
var Chart = /** @class */ (function () {
    ...
    Chart.prototype.create = function () {
        ...
        options.auxiliaries.forEach(function (options) {
            _this.auxiliaryDrawer.push(new options.drawer(_this, options.data));
        });
        this.resize();
    };
...
var TimeShareDrawer = /** @class */ (function () {
    ...
    TimeShareDrawer.prototype.drawXAxis = function (rect) {
    ...
    TimeShareDrawer.prototype.drawTimeShareLine = function () {
        ...
        var drawArea = Object(d3_shape__WEBPACK_IMPORTED_MODULE_1__["area"])()
            ...
            .y1(frame.height)
            .context(ctx);
        var drawLine = Object(d3_shape__WEBPACK_IMPORTED_MODULE_1__["line"])()
            .x(function (d, i) { return xScale(i); })
    ...
    ], TimeShareDrawer.prototype, "drawTimeShareLine", null);
...
var VolumeDrawer = /** @class */ (function () {
    ...
    VolumeDrawer.prototype.drawVolumes = function () {
        ...
        var xScale = this.chart.xScale;
        var _a = this, ctx = _a.context, yScale = _a.yScale;
        this.data.forEach(function (volume, i) {
            console.log(volume, yScale(volume));
            ctx.fillStyle = _this.calcDeltaPrice(volume, i, _this.data) >= 0 ? 'red' : 'green';
            var x = xScale(i), y = yScale(volume), height = frame.height - (y - frame.y), width = xScale(1) - 2;
    ...
    VolumeDrawer.prototype.resetYScale = function () {
        ...
        this.yScale = Object(d3_scale__WEBPACK_IMPORTED_MODULE_1__["scaleLinear"])()
            .domain([0, Object(d3_array__WEBPACK_IMPORTED_MODULE_2__["max"])(this.data)])
            .range([frame.y + frame.height, frame.y]);
    };
...
var content = __webpack_require__(/*! !../../node_modules/css-loader??ref--5-1!../../node_modules/postcss-loader/lib??ref--5-2!../../node_modules/sass-loader/lib/loader.js??ref--5-3!./index.scss */ "../node_modules/css-loader/index.js??ref--5-1!../node_modules/postcss-loader/lib/index.js??ref--5-2!../node_modules/sass-loader/lib/loader.js??ref--5-3!./scripts/index.scss");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.scss */ "./scripts/index.scss");
...
/* harmony import */ var _src_chart_chart__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../src/chart/chart */ "../src/chart/chart.ts");
/* harmony import */ var _src_chart_volume_drawer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../src/chart/volume-drawer */ "../src/chart/volume-drawer.ts");
...
var timeShareChart = new _src_chart_chart__WEBPACK_IMPORTED_MODULE_2__["Chart"]({
    selector: '#time-share',
    resolution: devicePixelRatio >= 2 ? 2 : 1,
    count: 30,
    main: {
        data: MOCK_PRICE.map(function (d) { return d.price; }),
        drawer: _src_chart_time_share_drawer__WEBPACK_IMPORTED_MODULE_1__["TimeShareDrawer"],
    },
    auxiliaries: [
        {
            data: MOCK_PRICE.map(function (d) { return d.volume; }),
            drawer: /** @class */ (function (_super) {
            ...
            }(_src_chart_volume_drawer__WEBPACK_IMPORTED_MODULE_3__["VolumeDrawer"]))
        }
    ]
});
